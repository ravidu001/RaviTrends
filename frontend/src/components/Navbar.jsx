    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <Link to='/cart' className='relative'>
                ...
                <span className='absolute -top-2 -right-2 bg-black text-white text-xs rounded-full px-1'>10</span>
            </Link>
            <img onClick={()=>setVisible(true)} src={assets.menu_icon} alt="menu" className='w-5 cursor-pointer sm:hidden' />
        </div>
        
        {/* Mobile Menu */}
        <div className={`absolute top-0 right-0 bottom-0 over-flow-hidden bg-white transition-all duration-300 ease-in-out ${visible ? 'w-full' : 'w-0'}`}>
